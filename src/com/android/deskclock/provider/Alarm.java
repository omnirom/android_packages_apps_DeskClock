...
public final class Alarm implements Parcelable, ClockContract.AlarmsColumns {
    ...
    private static final int PAIN_MODE_INDEX = 15;
    private static final int RANDOM_MODE_INDEX = 16;
    private static final int MEDIA_START_INDEX = 17;
    ...
    public static ContentValues createContentValues(Alarm alarm) {
        ...
        values.put(PAIN_MODE, alarm.painMode ? 1 : 0);
    ...
    public Alarm(Cursor c) {
        ...
        painMode = c.getInt(PAIN_MODE_INDEX) == 1;
    ...
    public boolean isFallbackRingtone(Context context, boolean preAlarm) {
        ...
        return getRingToneTitle(context, preAlarm).contains(unknownRingToneStr);
    }
}
