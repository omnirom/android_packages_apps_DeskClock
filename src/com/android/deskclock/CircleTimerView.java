...
public class CircleTimerView extends View {
    ...
    private static class MyViewOutlineProvider extends ViewOutlineProvider {
        public int mRadius;
        public int mX;
        public int mY;
        ...
        public void getOutline(View view, Outline outline) {
            outline.setOval(mX, mY, mRadius * 2, mRadius * 2);
        }
    }

    private static final MyViewOutlineProvider OVAL_OUTLINE_PROVIDER = new MyViewOutlineProvider();
    ...
    public void onDraw(Canvas canvas) {
        ...
        OVAL_OUTLINE_PROVIDER.mRadius = (int)radius + (int)mStrokeSize + 4;
        OVAL_OUTLINE_PROVIDER.mX = xCenter - OVAL_OUTLINE_PROVIDER.mRadius;
        OVAL_OUTLINE_PROVIDER.mY = yCenter - OVAL_OUTLINE_PROVIDER.mRadius;
