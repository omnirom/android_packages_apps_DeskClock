...
//                    }
            ...
            String ringtone = mContext.getResources().getString(R.string.disable_alarm);
            if (!alarm.mediaStart) {
...
//            itemHolder.increasingVolume.setVisibility((!alarm.preAlarm && silentAlarm) ? View.GONE : View.VISIBLE);
//
...
//                    asyncUpdateAlarm(alarm, false);
////                    itemHolder.alarmVolume.setVisibility(checked ? View.GONE : View.VISIBLE);
//                }
//            });
...
//                    boolean silentAlarm = alarm.alert != null && Alarm.NO_RINGTONE_URI.equals(alarm.alert);
//                    itemHolder.increasingVolume.setVisibility((!alarm.preAlarm && silentAlarm) ? View.GONE : View.VISIBLE);
...
//            itemHolder.alarmVolume.setVisibility(alarm.mediaStart ? View.GONE : View.VISIBLE);
...
//            });
            ...
            ringtone = mContext.getResources().getString(R.string.disable_alarm);
            if (mediaAlertEnabled){
                itemHolder.prealarmRingtone.setText(getMediaTitle(alarm.preAlarmAlert));
            } else {
                if (Alarm.NO_RINGTONE_URI.equals(alarm.preAlarmAlert)) {
                    ringtone = mContext.getResources().getString(R.string.silent_alarm_summary);
                } else {
